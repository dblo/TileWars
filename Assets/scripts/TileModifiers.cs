...
public static class TileModifiersFactory
{
    ...
    private static List<int> sPlainsCashValues = new List<int> { 1, 1, 1, 1 };
    ...
    private static List<int> sHillCashValues = new List<int> { 2, 3, 4, 5 };
    ...
    private static List<int> sMineCashValues = new List<int> { 5, 10, 15, 20 };
